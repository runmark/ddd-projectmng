package com.mark.projectmng.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mark.projectmng.service.EmailAlreadyUsedException ||
            ex instanceof com.mark.projectmng.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mark.projectmng.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.mark.projectmng");
    }
}
